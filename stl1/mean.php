...
if (isset($_GET['submit_T'])) {
    ...
    if (is_string($data_T)) {
        ...
        sort($data_T);
        $datastrsorted = intArrayToStr($data_T);
...
if (isset($_GET['submit_kt'])) {
    ...
    for ($i = 0; $i < $row; $i++) {
        ...
        $fixi = ((float)$fValue * (float)$xiValue);
        $sfi += $fValue;
                        ...
                        <div class="row rounded">
                            ...
                            <div class="col border-start">
                                ...
                                <div class="border border-primary rounded p-2 bg-primary bg-gradient" style="--bs-bg-opacity: .5; ">
                                    ...
                                    <p>Data Sort : <?= $datastrsorted ?></p>

                                    <p> $$\Huge\boxed{\Large\bar{x} = \large\frac{ \displaystyle\sum_{i=1}^{n} x_i}{n}}$$</p>

                                    <!-- <p>$$\large\bar{x}=\frac{<?= $datasum ?>}{<?= $n ?>}$$</p> -->

                                    <p style="overflow:auto;">
                                        $$\displaystyle \Large\begin{array}{rcl}
                                        \bar{x}
                                        & = & \displaystyle\frac{<?php
                                                                    for ($i = 0; $i < $n; $i++) {
                                                                        if ($i == $n - 1) {
                                                                            echo $data_T[$i] . '';
                                                                        } else {
                        ...
                        <div class="col border-start">
                            ...
                            <div class="border border-warning rounded bg-warning bg-gradient row mx-1" style="--bs-bg-opacity: .45;">
                                <div
                                    ...
                                    \begin{array}{|c|c|c|c|}
                                    \hline
                                    \text{Interval} & f_i & f_i.x_i & \sum f_i \\
                                    ...
                                    ?>
                                            <?= $njir['nt'] ?> & <?= $njir['ft'] ?> & <?= $njir['ft'] ?> \times <?= $njir['nt'] ?> = <?= $njir['fixi'] ?> & <?= $njir['sfi'] ?> \\
                                            \hline
                                    <?php endforeach;
                                    endif; ?>
                                    \end{array}
